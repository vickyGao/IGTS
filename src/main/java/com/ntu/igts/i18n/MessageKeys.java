...
public class MessageKeys {
    ...
    public static final String CANNOT_DELETE_TAG_WITH_SUB_TAG = "cannot.delete.tag_with.sub.tag";
    public static final String TAG_NOT_FOUND_FOR_ID = "tag.not.found.for.id";
    public static final String CREATE_TAG_FAILED = "create.tag.failed";
    public static final String UPDATE_TAG_FAILED = "update.tag.failed";
    public static final String DELETE_TAG_FOR_ID_SUCCESS = "delete.tag.for.id.success";
    public static final String DELETE_TAG_FOR_ID_FAIL = "delete.tag.for.id.fail";
