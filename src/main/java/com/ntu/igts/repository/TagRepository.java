...
public interface TagRepository extends MyRepository<Tag, String> {
    ...
    public List<Tag> getTagsForParentId(@Param("parentId") String parentId);
    ...
    public List<Tag> getTopLevelTagsForCommodityId(@Param("commodityId") String commodityId);

    @Query("from Tag t where t.standardName=:standardName and t.deletedYN='N'")
    public Tag getTagForStandardName(@Param("standardName") String standardName);
